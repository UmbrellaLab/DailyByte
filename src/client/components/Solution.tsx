  ...
  return (
    <div>
      <div className='usernameHeader'>
        ...
        <button onClick={() => handleStar(solutionData.solution_id)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-star" viewBox="0 0 16 16">
